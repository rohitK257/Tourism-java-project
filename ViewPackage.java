...
public class ViewPackage extends JFrame implements ActionListener{
    ...
    ViewPackage(String username){
        ...
        JLabel lblnumber=new JLabel("Number of People");
        ...
        labelemail.setBounds(220,210,150,25);
        add(labelemail);
        ...
        labelphone.setBounds(220,250,170,25);
        add(labelphone);
        ...
        try{
            ...
            while(rs.next()){
                ...
                labelemail.setText(rs.getString("number"));
